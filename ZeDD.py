...
\x1b[7m Insta : Zee_0oo07\x1b[0m
\x1b[7m Pakistan Cyber System & Crackerz\x1b[0m
\x1b[1;99m[●]▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬[●]\x1b[0m
"""
...
def tik():
	titik = ['. ','.. ','... ']
	for o in titik:
		print("\r\033[1;96m[●] \x1b[1;93mLoading Please Wait[1;97m"+o),;sys.stdout.flush();time.sleep(1)
...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;97mEnter Your Name To Continue Using The Tool…!!\033[1;91m: \033[1;92m")
	if nama =="":
		print"\033[1;96m[!] \033[1;91mWellcome To Our Cracking Tool "
		time.sleep(1)
		siapa()
	else:
		os.system('clear')
		jalan("\033[1;97mStay Home Stay Safe \033[1;96m" +nama+ "\n\033[1;97mThankiiew For Using Our Tool...") 
                time.sleep(1)
		loginSC()
...
def loginSC():
	os.system('clear')
	print"\033[1;97mIf You Don't Know The Username & Password Then Ask Owner Of Tool...!!"
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print(' \x1b[7m Author : Zee\x1b[0m ')
                print('\033[1;96m[☆]\x1b[0m \x1b[7mLogin With Facebook ID\033[1;96m[☆]\x1b[0m' )
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\n\033[1;96m[✓] \\x1b[7mLogin Successful...\x1b[0m'
...
def pilih_super():
	...
	if peak =="":
		...
		print logo
		print 42*"\033[1;96m="
		jalan('\033[1;96m[✺] \033[1;93mOpening IDz \033[1;97m...')
		...
		try:
			...
			super()
		jalan('\033[1;96m[✺] \033[1;93mCloning Start\033[1;97m...')
